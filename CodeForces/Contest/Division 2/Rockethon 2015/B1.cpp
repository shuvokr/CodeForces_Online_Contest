    ...
    for(int i = 1; i <= 4 && m; i++)
    {
        if(i == 1)
        {
            ...
            do
            {
                ...
                {
                    cout << ar[ 0 ];
                    for(int k = 1; k < n; k++) cout << " " << ar[ k ]; puts("");
                    break;
                }
                if(p == 0) break;
            }while(next_permutation(ar + 2, ar + n));
        }
        ...
        if(i == 4)
        {
            ...
            do
            {
                ...
                if(p == 0) break;
            }while(next_permutation(ar, ar + n - 2));
        }
    }
}
