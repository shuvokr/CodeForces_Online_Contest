...
#define resx(i, a, b, c) ((b * power(i, a)) + c)
...
void input()
{
    long long a, b, c, x, tot, tmp, tmp2, fres[ 100 ], k = 0;
    cin >> a >> b >> c;
    //printf("%I64d\n", resx(81, 5, 10000, 10000));
    //printf("%I64d\n", 10000*(power(81, 5)) + 10000);
    ...
    {
        printf("%I64d", fres[ 0 ]);
        for(int i = 1; i < k; i++) printf(" %I64d", fres[ i ]);
        puts("");
    }
}
