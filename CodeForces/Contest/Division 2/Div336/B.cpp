...
void Input()
{
	...
	for(int i = 0; i < len2; i++)
	{
		...
		if(b[ i ] == '0') save[ i + 1 ].z = save[ i ].z + 1, save[i + 1].o = save[ i ].o;
		else save[i + 1].o = save[ i ].o + 1, save[i + 1].z = save[ i ].z;
	}
	//for(int i = 1; i <= len2; i++) pi2(save[i].o, save[i].z);
	lld ans = 0;
