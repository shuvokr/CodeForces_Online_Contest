...
int in[ 200010 ], n, z[ 200010 ], o[ 200010 ];
...
void input()
{
    ...
    for(int i = 1; i <= n; i++) o[ i ] = o[ i ] + o[i - 1];
    for(int i = 1; i <= n; i++) z[ i ] = z[ i ] + z[i - 1];

    long long res1 = 0ll, res2 = 0ll, res;
    for(int i = 1; i <= n; i++)
        if(in[ i ]) res1 += z[ n ] - z[ i ];
