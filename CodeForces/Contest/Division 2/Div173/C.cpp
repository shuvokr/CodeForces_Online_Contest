...
void input()
{
    ...
    if(a.size() == 1 && a[0] == b[0]) {puts("YES"); return;}
    if(a.size() == 1 && a[0] != b[0]) {puts("NO"); return;}
    bool o1 = 0, o2 = 0;
    for(int i = 0; i < a.size(); i++) if(a[ i ] == '1') {o1 = 1; i = a.size();}
    for(int i = 0; i < b.size(); i++) if(b[ i ] == '1') {o2 = 1; i = b.size();}
    puts(o1 && o2 ? "YES" : "NO");
}
